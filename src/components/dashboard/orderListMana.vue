 ...
 * @LastEditTime: 2019-07-12 14:55:20
 * @Author: yuhenglong
...
export default {
  ...
  data() {
    return {
      ...
      newObjArr: [
        ...
        { label: "公司编号", prop: "categoryId" },
        { label: "收货单位", prop: "status" },
        { label: "收货地址", prop: "companyAddress" },
        { label: "状态", prop: "status" },
        { label: "下单时间", prop: "responsiblePerson" },
        { label: "交货时间", prop: "personPhone" }
      ],
      newObjArrSub: [
        { label: "产品名称", prop: "name" },
        { label: "产品编号", prop: "categoryId" },
  ...
  methods: {
    ...
    getUsers() {
      ...
      this.axios
        .post("/api/order/selectPage", qs.stringify(params))
        .then(res => {
